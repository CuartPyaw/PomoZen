...
declare module '#imports' {
  ...
  export { DailyLineChart, WeeklyBarChart } from '../components/FocusCharts';
  export { useNotifications, NotificationState } from '../hooks/useNotifications';
  export { useSettings } from '../hooks/useSettings';
  export { useStatistics } from '../hooks/useStatistics';
  export { useTaskStatistics, UseTaskStatisticsReturn } from '../hooks/useTaskStatistics';
  export { useTasks, UseTasksReturn } from '../hooks/useTasks';
  export { useTheme, ThemeModePreference } from '../hooks/useTheme';
  export { useTimer } from '../hooks/useTimer';
  export { playNotificationSound, playTestSound } from '../utils/audioPlayer';
  export { LogLevel, LogLevel, Logger } from '../utils/logger';
  export { StorageManager, SyncStorageManager } from '../utils/storage';
}
